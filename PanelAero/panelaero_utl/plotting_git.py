...
class DetailedPlots():
    ...
    def plot_aerogrid(self, scalars=None, colormap='plasma', outfile=None, title=None):
        """
        ...
        title : str, optional
            Title for the plot
        """
        # Debug: print aerogrid structure
        print(f"DEBUG: aerogrid type = {type(self.model)}")
        if isinstance(self.model, dict):
            print(f"DEBUG: aerogrid keys = {list(self.model.keys())}")
        ...
        # Save figure if outfile is provided
        if outfile:
