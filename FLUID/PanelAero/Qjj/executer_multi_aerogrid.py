...
def main(start_time=None):
    ...
    sys.path.extend([
        ...
        FSI_path + '/FLUID/PanelAero/panelaero_utl/old',
        ...
        for n_span in nspan:
            for aspect_ratio in AR:
                ...
                if plot:
                    ...
                    try:
                        plot_out_dir = Path(
                            FSI_path + "/FLUID/PanelAero/Qjj/qjj_precomputed"
    ...
    csv_out_path = _Path(out_dir).parent / 'executer_multi_aerogrid_diagnostics.csv'
