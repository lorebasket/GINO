...
def rotate_matrices_by_angle(K, M, axis, angle, section_keys=None):
    ...
    Parameters:
    - K: dictionary of 6x6 stiffness matrices or a single 6x6 matrix
    - M: dictionary of 6x6 mass matrices or a single 6x6 matrix
    - axis: rotation axis ('x', 'y', 'z' or 3D unit vector)
    - angle: rotation angle in radians
    - section_keys: list of section keys to rotate (if None, rotates all)
    
    Returns:
    - K_rotated: rotated stiffness matrices or matrix
    - M_rotated: rotated mass matrices or matrix
    """
