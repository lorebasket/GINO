...
def _load_rfa_matrices(config, output_dir=None):
    ...
    matrices from: /output_plots/RFA_matrices/{config.name}/panel_space/
    ...
    if output_dir is None:
        output_dir = getattr(config, 'output_dir', '/media/lorenzo/Seagate Por/recupero dati Linux/lorebasket/FSI/output_plots/')
...
def _fluidrest_analysis_modal_dofs(structural_results, capytaine_data, config):
    ...
    **File Format (RFA):** /output_plots/RFA_matrices/{config.name}/panel_space/
