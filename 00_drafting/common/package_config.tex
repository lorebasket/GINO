...
% -------------------------------------------------------
%  Colour palette – PK-method flowchart (chap3)
% -------------------------------------------------------
\definecolor{nastranGray}{RGB}{180,180,180}
\definecolor{devRed}{RGB}{200,40,40}
\definecolor{blockBlue}{RGB}{220,235,255}
\definecolor{blockGreen}{RGB}{220,245,220}
\definecolor{blockRed}{RGB}{255,225,220}
\definecolor{blockYellow}{RGB}{255,250,210}
\definecolor{termColor}{RGB}{200,220,255}
\definecolor{decisionColor}{RGB}{255,245,200}

% -------------------------------------------------------
%  TikZ styles – PK-method flowchart (chap3)
% -------------------------------------------------------
\tikzset{
  terminal/.style={
  ...
  procDev/.style={
    rectangle, draw=devRed, very thick,
    fill=blockRed,
    text width=3.8cm, align=center,
    minimum height=0.8cm, font=\small
  },
  ...
  arrRed/.style={-{Stealth[length=6pt]}, very thick, devRed},
}