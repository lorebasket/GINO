...
\begin{minipage}[t]{.35\textwidth}\raggedright
    ...
    \begin{tabular}[t]{@{}l@{}}
        ...
        \fixednamesfont \textbf{\thesisexternalsupervisortext} \\
        ...
        \namesfont \xmakefirstuc{\thesissupervisorfivetitle}~\thesissupervisorfivename~\MakeUppercase{\thesissupervisorfivesurname}
    \end{tabular}
    %\end{adjustbox}
\end{minipage}
%
